...
public interface SearchApi {
    ...
    default ResponseEntity<SearchPost200Response> searchPost(
        @Parameter(name = "SearchPostRequest", description = "BAP searches for services") @Valid @RequestBody(required = false) SearchPostRequest searchPostRequest
    ) {
        return getDelegate().searchPost(searchPostRequest);
    }
