...
public interface RatingApi {
    ...
    default ResponseEntity<SearchPost200Response> ratingPost(
        @Parameter(name = "RatingPostRequest", description = "TODO") @Valid @RequestBody(required = false) RatingPostRequest ratingPostRequest
    ) {
        return getDelegate().ratingPost(ratingPostRequest);
    }
