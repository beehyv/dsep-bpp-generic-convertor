...
@Validated
@Tag(name = "return_reasons", description = "the return_reasons API")
@RequestMapping("${openapi.becknCore.base-path:}")
public interface ReturnReasonsApi {

    default ReturnReasonsApiDelegate getDelegate() {
        return new ReturnReasonsApiDelegate() {};
    }
    ...
    default ResponseEntity<SearchPost200Response> returnReasonsPost(
        @Parameter(name = "ReturnReasonsPostRequest", description = "List of return reasons") @Valid @RequestBody(required = false) ReturnReasonsPostRequest returnReasonsPostRequest
    ) {
        return getDelegate().returnReasonsPost(returnReasonsPostRequest);
    }
