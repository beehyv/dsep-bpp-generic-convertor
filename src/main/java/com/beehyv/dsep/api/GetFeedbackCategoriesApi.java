...
@Validated
@Tag(name = "get_feedback_categories", description = "the get_feedback_categories API")
@RequestMapping("${openapi.becknCore.base-path:}")
public interface GetFeedbackCategoriesApi {

    default GetFeedbackCategoriesApiDelegate getDelegate() {
        return new GetFeedbackCategoriesApiDelegate() {};
    }
     ...
     */
    @Operation(
        operationId = "getFeedbackCategoriesPost",
        tags = { "BPP Meta APIs" },
        responses = {
    ...
    default ResponseEntity<SearchPost200Response> getFeedbackCategoriesPost(
        ...
        return getDelegate().getFeedbackCategoriesPost(getCancellationReasonsPostRequest);
    }
