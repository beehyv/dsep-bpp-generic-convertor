...
@Validated
@Tag(name = "on_confirm", description = "the on_confirm API")
@RequestMapping("${openapi.becknCore.base-path:}")
public interface OnConfirmApi {

    default OnConfirmApiDelegate getDelegate() {
        return new OnConfirmApiDelegate() {};
    }
    ...
    default ResponseEntity<SearchPost200Response> onConfirmPost(
        ...
        return getDelegate().onConfirmPost(onConfirmPostRequest);
    }
