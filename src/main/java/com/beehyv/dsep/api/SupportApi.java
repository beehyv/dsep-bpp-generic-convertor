...
@Validated
@Tag(name = "support", description = "the support API")
@RequestMapping("${openapi.becknCore.base-path:}")
public interface SupportApi {

    default SupportApiDelegate getDelegate() {
        return new SupportApiDelegate() {};
    }
    ...
    default ResponseEntity<SearchPost200Response> supportPost(
        @Parameter(name = "SupportPostRequest", description = "TODO") @Valid @RequestBody(required = false) SupportPostRequest supportPostRequest
    ) {
        return getDelegate().supportPost(supportPostRequest);
    }
