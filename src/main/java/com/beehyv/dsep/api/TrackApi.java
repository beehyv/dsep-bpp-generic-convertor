...
public interface TrackApi {
    ...
    default TrackApiDelegate getDelegate() {
        return new TrackApiDelegate() {};
    }
    ...
    default ResponseEntity<SearchPost200Response> trackPost(
        @Parameter(name = "TrackPostRequest", description = "TODO") @Valid @RequestBody(required = false) TrackPostRequest trackPostRequest
    ) {
        return getDelegate().trackPost(trackPostRequest);
    }
