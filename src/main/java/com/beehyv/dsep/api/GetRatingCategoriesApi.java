...
@Validated
@Tag(name = "get_rating_categories", description = "the get_rating_categories API")
@RequestMapping("${openapi.becknCore.base-path:}")
public interface GetRatingCategoriesApi {

    default GetRatingCategoriesApiDelegate getDelegate() {
        return new GetRatingCategoriesApiDelegate() {};
    }
     ...
     */
    @Operation(
        operationId = "getRatingCategoriesPost",
        tags = { "BPP Meta APIs" },
        responses = {
    ...
    default ResponseEntity<SearchPost200Response> getRatingCategoriesPost(
        ...
        return getDelegate().getRatingCategoriesPost(getCancellationReasonsPostRequest);
    }
