...
public interface StatusApi {
    ...
    default ResponseEntity<SearchPost200Response> statusPost(
        @Parameter(name = "StatusPostRequest", description = "TODO") @Valid @RequestBody(required = false) StatusPostRequest statusPostRequest
    ) {
        return getDelegate().statusPost(statusPostRequest);
    }
