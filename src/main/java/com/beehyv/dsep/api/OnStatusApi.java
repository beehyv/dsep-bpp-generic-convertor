...
@Validated
@Tag(name = "on_status", description = "the on_status API")
@RequestMapping("${openapi.becknCore.base-path:}")
public interface OnStatusApi {

    default OnStatusApiDelegate getDelegate() {
        return new OnStatusApiDelegate() {};
    }
    ...
    default ResponseEntity<SearchPost200Response> onStatusPost(
        ...
        return getDelegate().onStatusPost(onConfirmPostRequest);
    }
