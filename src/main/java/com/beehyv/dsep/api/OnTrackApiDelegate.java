...
import com.beehyv.dsep.model.OnTrackPostRequest;
...
/**
 * A delegate to be called by the {@link OnTrackApiController}}.
 * Implement this interface with a {@link org.springframework.stereotype.Service} annotated class.
 */
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2023-02-25T15:22:03.145011300+05:30[Asia/Calcutta]")
public interface OnTrackApiDelegate {
     ...
     *
     * @param onTrackPostRequest TODO (optional)
     * @return Acknowledgement of message received (status code 200)
     * @see OnTrackApi#onTrackPost
     */
    default ResponseEntity<SearchPost200Response> onTrackPost(OnTrackPostRequest onTrackPostRequest) {
        LOGGER.info("Recieved on track request");
