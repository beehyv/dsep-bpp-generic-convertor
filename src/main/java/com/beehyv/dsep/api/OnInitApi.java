...
@Validated
@Tag(name = "on_init", description = "the on_init API")
@RequestMapping("${openapi.becknCore.base-path:}")
public interface OnInitApi {

    default OnInitApiDelegate getDelegate() {
        return new OnInitApiDelegate() {};
    }
    ...
    default ResponseEntity<SearchPost200Response> onInitPost(
        @Parameter(name = "OnInitPostRequest", description = "TODO") @Valid @RequestBody(required = false) OnInitPostRequest onInitPostRequest
    ) {
        return getDelegate().onInitPost(onInitPostRequest);
    }
