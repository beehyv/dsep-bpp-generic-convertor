...
@Validated
@Tag(name = "get_cancellation_reasons", description = "the get_cancellation_reasons API")
@RequestMapping("${openapi.becknCore.base-path:}")
public interface GetCancellationReasonsApi {

    default GetCancellationReasonsApiDelegate getDelegate() {
        return new GetCancellationReasonsApiDelegate() {};
    }
     ...
     */
    @Operation(
        operationId = "getCancellationReasonsPost",
        tags = { "BPP Meta APIs" },
        responses = {
    ...
    default ResponseEntity<SearchPost200Response> getCancellationReasonsPost(
        ...
        return getDelegate().getCancellationReasonsPost(getCancellationReasonsPostRequest);
    }
