...
@Validated
@Tag(name = "on_support", description = "the on_support API")
@RequestMapping("${openapi.becknCore.base-path:}")
public interface OnSupportApi {

    default OnSupportApiDelegate getDelegate() {
        return new OnSupportApiDelegate() {};
    }
    ...
    default ResponseEntity<SearchPost200Response> onSupportPost(
        @Parameter(name = "OnSupportPostRequest", description = "TODO") @Valid @RequestBody(required = false) OnSupportPostRequest onSupportPostRequest
    ) {
        return getDelegate().onSupportPost(onSupportPostRequest);
    }
