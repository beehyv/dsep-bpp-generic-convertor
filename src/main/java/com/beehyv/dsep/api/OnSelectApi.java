...
@Validated
@Tag(name = "on_select", description = "the on_select API")
@RequestMapping("${openapi.becknCore.base-path:}")
public interface OnSelectApi {

    default OnSelectApiDelegate getDelegate() {
        return new OnSelectApiDelegate() {};
    }
    ...
    default ResponseEntity<SearchPost200Response> onSelectPost(
        @Parameter(name = "OnSelectPostRequest", description = "TODO") @Valid @RequestBody(required = false) OnSelectPostRequest onSelectPostRequest
    ) {
        return getDelegate().onSelectPost(onSelectPostRequest);
    }
