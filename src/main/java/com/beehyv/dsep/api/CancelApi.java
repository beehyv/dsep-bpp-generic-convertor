...
public interface CancelApi {
    ...
    default CancelApiDelegate getDelegate() {
        return new CancelApiDelegate() {};
    }
    ...
    default ResponseEntity<SearchPost200Response> cancelPost(
        @Parameter(name = "CancelPostRequest", description = "TODO") @Valid @RequestBody(required = false) CancelPostRequest cancelPostRequest
    ) {
        return getDelegate().cancelPost(cancelPostRequest);
    }
