...
@Validated
@Tag(name = "on_update", description = "the on_update API")
@RequestMapping("${openapi.becknCore.base-path:}")
public interface OnUpdateApi {

    default OnUpdateApiDelegate getDelegate() {
        return new OnUpdateApiDelegate() {};
    }
    ...
    default ResponseEntity<SearchPost200Response> onUpdatePost(
        ...
        return getDelegate().onUpdatePost(onConfirmPostRequest);
    }
