...
@Validated
@Tag(name = "cancellation_reasons", description = "the cancellation_reasons API")
@RequestMapping("${openapi.becknCore.base-path:}")
public interface CancellationReasonsApi {

    default CancellationReasonsApiDelegate getDelegate() {
        return new CancellationReasonsApiDelegate() {};
    }
     ...
     */
    @Operation(
        operationId = "cancellationReasonsPost",
        tags = { "BAP Meta APIs" },
        responses = {
    ...
    default ResponseEntity<SearchPost200Response> cancellationReasonsPost(
        @Parameter(name = "CancellationReasonsPostRequest", description = "List of cancellation reasons") @Valid @RequestBody(required = false) CancellationReasonsPostRequest cancellationReasonsPostRequest
    ) {
        return getDelegate().cancellationReasonsPost(cancellationReasonsPostRequest);
    }
